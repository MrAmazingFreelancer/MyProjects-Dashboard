...
<head>
    ...
    <title><?php echo htmlspecialchars(ucfirst($currentName), ENT_QUOTES, 'UTF-8'); ?> | Shared Projects</title>
...
<body data-page="projects">
    <main class="wrap">
        <header class="head">
            <h1><?php echo htmlspecialchars(ucfirst($currentName), ENT_QUOTES, 'UTF-8'); ?></h1>
            <p class="sub">Folder view inside /projects/<?php echo htmlspecialchars($currentName, ENT_QUOTES, 'UTF-8'); ?>/</p>
            <div class="quick">
                <a class="pill" href="../">Back</a>
                <a class="pill" href="/projects/">Projects Home</a>
                <a class="pill" href="/index.php">Hub</a>
            </div>
        </header>
        ...
        <div class="content">
            <section>
                ...
                <?php else: ?>
                <p class="empty">No subdirectories found.</p>
                <?php endif; ?>
            </section>
